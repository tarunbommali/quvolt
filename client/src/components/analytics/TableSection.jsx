...
const TableSection = ({ rows = [] }) => (
    <div className={components.analytics.cardCompact}>
        <h3 className={components.analytics.sectionTitleUpper}>Top Quizzes</h3>
            ...
            <table className={components.analytics.table}>
                <thead>
                    <tr className={components.analytics.tableHeadRow}>
                        <th className={components.analytics.tableHeadCell}>Quiz</th>
                ...
                <tbody>
                    {rows.map((row, index) => (
                        ...
                        >
                            <td className={components.analytics.tableBodyCellStrong}>{row.title || 'Untitled Quiz'}</td>
