...
import { startLiveSession } from '../services/quiz.service';
...
const QuizLobbyPage = () => {
    ...
    // Called by TemplateConfigPanel when host clicks "Start Session"
    const handleTemplateStart = async (_templateDraft) => {
        setShowTemplatePanel(false);
        await startQuizBroadcast();
    };
    ...
    return (
        <>
            ...
            <LiveLobby
                ...
                navigate={navigate}
                startQuizBroadcast={() => setShowTemplatePanel(true)}
                showToast={showToast}
                onAbort={handleAbort}
