...
import { loginUser as loginService } from '../services/auth.service';
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="space-y-2">
                        ...
                        <div className="relative group">
                            <Mail className="absolute left-4 top-3.5 text-gray-400 z-10 pointer-events-none group-focus-within:text-[var(--qb-primary)] transition-colors" size={18} />
                            <InputField
                                id="login-email"
                                type="email"
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative group">
                            <Lock className="absolute left-4 top-3.5 text-gray-400 z-10 pointer-events-none group-focus-within:text-[var(--qb-primary)] transition-colors" size={18} />
                            <InputField
                                id="login-password"
                            ...
                            />
                             <button
                                ...
                                className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700 z-10 px-2"
