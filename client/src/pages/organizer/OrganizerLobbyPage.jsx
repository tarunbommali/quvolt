...
const OrganizerLobbyPage = () => {
	...
	useEffect(() => {
		...
		joinRoom(hostJoinRoomCode);
	}, [loading, activeQuiz, joinRoom, sessionCode]);
	...
	return (
		<>
			...
			<LiveLobby
				...
				startQuizSocketBroadcast={startQuizSocketBroadcast}
			/>
		</>
	);
};

export default OrganizerLobbyPage;